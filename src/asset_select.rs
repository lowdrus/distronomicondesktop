...
fn score(name: &str) -> i32 {
    ...
    let mut value = 0;
    if n.contains("windows") || n.contains("win64") || n.contains("win-") {
        value += 40;
    }
    if n.contains("x86_64") || n.contains("x64") || n.contains("amd64") {
        value += 30;
    }
    if n.ends_with(".zip") {
        value += 8;
    ...
    if n.contains("arm64") || n.contains("aarch64") || n.contains("i686") {
        value -= 25;
    }
    value
}
